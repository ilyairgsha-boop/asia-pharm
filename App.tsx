    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {currentPage === 'home' && (
        <button
          ...
          className="mobile-floating-cart md:hidden fixed bottom-6 right-6 w-16 h-16 bg-red-600 text-white rounded-full shadow-lg flex items-center justify-center z-40 hover:bg-red-700 transition-all hover:scale-110"
        >
          <ShoppingCart size={28} strokeWidth={1.5} className="mobile-floating-cart-icon" />
          {totalItemsCount > 0 && (
            <span className="mobile-floating-cart-badge absolute -top-1 -right-1 bg-yellow-400 text-black rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">
              {totalItemsCount}
            </span>
          )}
        </button>
