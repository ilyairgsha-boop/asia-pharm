          ...
          <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-lg shadow-md p-6 text-white">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-2xl">{loyaltyPoints.toLocaleString()} {t('points')}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg">{monthlyTotal.toLocaleString()} ₽</p>
                {monthlyTotal < 10000 && (
                  <p className="text-xs text-red-100 mt-1">
                    {(10000 - monthlyTotal).toLocaleString()} ₽ {t('untilPremium')}
                  </p>
                )}
              </div>
            </div>
