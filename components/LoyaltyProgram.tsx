          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 my-6">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-5 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-gray-400 rounded-full flex items-center justify-center text-white">1</div>
              ...
              <div className="mt-3 p-3 bg-white rounded border border-gray-300">
                ...
                <p className="m-0 text-green-600 mt-2 text-xl"><strong>3%</strong></p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-lg border border-blue-200">
              ...
              <div className="mt-3 p-3 bg-white rounded border border-blue-300">
                ...
                <p className="m-0 text-blue-600 mt-2 text-xl"><strong>5%</strong></p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-5 rounded-lg border border-yellow-300">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white">3</div>
              ...
              <div className="mt-3 p-3 bg-white rounded border border-yellow-400">
                ...
                <p className="m-0 text-yellow-600 mt-2 text-xl"><strong>7%</strong></p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-5 rounded-lg border-2 border-red-300">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-red-600 rounded-full flex items-center justify-center text-white">4</div>
              ...
              <div className="mt-3 p-3 bg-white rounded border border-red-400">
                ...
                <p className="m-0 text-red-600 mt-2 text-xl"><strong>10%</strong></p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mt-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-green-600 m-0 mt-2"><strong>{t('exampleProgressiveTotal')}</strong></p>
              </div>
              <div className="pt-3 border-t border-blue-200">
                ...
                <p className="text-green-600 m-0 mt-2"><strong>{t('exampleHighLevelTotal')}</strong></p>
              </div>
            </div>
          </div>
